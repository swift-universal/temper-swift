...
@Suite struct InstallTests {
    ...
    @Test(.testHomeMockedToolchain()) func installLatest() async throws {
        try await TemperSwiftTests.runCommand(Install.self, ["install", "latest", "--post-install-file=\(fs.mktemp())"])
        ...
        try await TemperSwiftTests.validateInstalledToolchains([installedToolchain], description: "install latest")
    }
    ...
    @Test(.testHomeMockedToolchain()) func installLatestPatchVersion() async throws {
        try await TemperSwiftTests.runCommand(Install.self, ["install", "5.7", "--post-install-file=\(fs.mktemp())"])
    ...
    @Test(.testHomeMockedToolchain()) func installReleases() async throws {
        ...
        try await TemperSwiftTests.runCommand(Install.self, ["install", "5.7.0", "--post-install-file=\(fs.mktemp())"])
        ...
        try await TemperSwiftTests.runCommand(Install.self, ["install", "5.7.2", "--post-install-file=\(fs.mktemp())"])
    ...
    @Test(.testHomeMockedToolchain()) func installSnapshots() async throws {
        ...
        try await TemperSwiftTests.runCommand(Install.self, ["install", "main-snapshot-2023-04-01", "--post-install-file=\(fs.mktemp())"])
        ...
        try await TemperSwiftTests.runCommand(Install.self, ["install", "5.9-snapshot-2023-04-01", "--post-install-file=\(fs.mktemp())"])
    ...
    @Test(.testHomeMockedToolchain()) func installLatestMainSnapshot() async throws {
        try await TemperSwiftTests.runCommand(Install.self, ["install", "main-snapshot", "--post-install-file=\(fs.mktemp())"])
    ...
    @Test(.testHomeMockedToolchain()) func installLatestReleaseSnapshot() async throws {
        try await TemperSwiftTests.runCommand(Install.self, ["install", "6.0-snapshot", "--post-install-file=\(fs.mktemp())"])
    ...
    @Test(.testHomeMockedToolchain()) func installReleaseAndSnapshots() async throws {
        ...
        try await TemperSwiftTests.runCommand(Install.self, ["install", "5.9-snapshot-2023-03-28", "--post-install-file=\(fs.mktemp())"])

        try await TemperSwiftTests.runCommand(Install.self, ["install", "5.8.0", "--post-install-file=\(fs.mktemp())"])
    ...
    func duplicateTest(_ version: String) async throws {
        try await TemperSwiftTests.withTestHome {
            try await TemperSwiftTests.withMockedToolchain {
                try await TemperSwiftTests.runCommand(Install.self, ["install", version, "--post-install-file=\(fs.mktemp())"])
    ...
    @Test(.testHomeMockedToolchain(), arguments: ["5.8.0", "latest"]) func installDuplicateReleases(_ installVersion: String) async throws {
        try await TemperSwiftTests.runCommand(Install.self, ["install", installVersion, "--post-install-file=\(fs.mktemp())"])
    ...
    @Test(.testHomeMockedToolchain()) func installUsesFirstToolchain() async throws {
        ...
        try await TemperSwiftTests.validateInUse(expected: nil)

        try await TemperSwiftTests.runCommand(Install.self, ["install", "5.7.0", "--post-install-file=\(fs.mktemp())"])

        try await TemperSwiftTests.validateInUse(expected: ToolchainVersion(major: 5, minor: 7, patch: 0))

        try await TemperSwiftTests.runCommand(Install.self, ["install", "5.7.1", "--post-install-file=\(fs.mktemp())"])
    ...
    @Test(.mockedTemperSwiftVersion(), .testHomeMockedToolchain()) func installUseFlag() async throws {
        try await TemperSwiftTests.installMockedToolchain(toolchain: .oldStable)
        try await TemperSwiftTests.runCommand(Use.self, ["use", ToolchainVersion.oldStable.name])
        try await TemperSwiftTests.validateInUse(expected: .oldStable)
        try await TemperSwiftTests.installMockedToolchain(selector: ToolchainVersion.newStable.name, args: ["--use"])
    ...
    @Test(.mockedTemperSwiftVersion(), .testHomeMockedToolchain()) func installUseFlagOnAlreadyInstalledToolchain() async throws {
        ...
        try await TemperSwiftTests.installMockedToolchain(selector: ToolchainVersion.newStable.name)
    ...
    @Test(.testHomeMockedToolchain()) func installXcode() async throws {
        try await #expect(throws: TemperSwiftError.self) {
            try await TemperSwiftTests.runCommand(Install.self, ["install", "xcode", "--post-install-file=\(fs.mktemp())"])
        }
    }
    ...
    @Test(.testHomeMockedToolchain()) func installProgressFile() async throws {
        ...
        try await TemperSwiftTests.runCommand(Install.self, [
            "install", "5.7.0",
    ...
    func installProgressFileNamedPipe() async throws {
        ...
        let readerTask = Task {
            ...
            guard let fileHandle = FileHandle(forReadingAtPath: pipePath) else { throw TemperSwiftError(message: "Unable to open file handle at \(pipePath)") }
