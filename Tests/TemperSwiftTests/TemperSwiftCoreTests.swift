...
/// Test actor for capturing output from TemperSwiftCoreContext functions
...
@Suite struct TemperSwiftCoreContextTests {
    @Test func testMessageText() async throws {
        let handler = TestOutputCapture()
        var context = TemperSwiftCoreContext(format: .text)
    ...
    @Test func testMessageJSON() async throws {
        ...
        var context = TemperSwiftCoreContext(format: .json)
