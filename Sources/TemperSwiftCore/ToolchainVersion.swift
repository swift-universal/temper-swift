    ...
    public init(parsing string: String) throws {
        if let match = try Self.stableRegex().wholeMatch(in: string) {
            guard
                ...
                throw TemperSwiftError(message: "invalid stable version: \(string)")
            }
            ...
            guard
                ...
                throw TemperSwiftError(message: "invalid release snapshot version: \(string)")
            }
            ...
            throw TemperSwiftError(message: "invalid toolchain version: \"\(string)\"")
        }
    }
...
public enum ToolchainSelector: Sendable {
    ...
    public init(parsing input: String) throws {
        ...
        throw TemperSwiftError(message: "invalid toolchain selector: \"\(input)\"")
    }
...
struct ReleaseSnapshotParser: ToolchainSelectorParser {
    ...
    func parse(_ input: String) throws -> ToolchainSelector? {
        ...
        guard
            ...
            throw TemperSwiftError(message: "malformatted version: \(match.output.1).\(match.output.2)")
        }
