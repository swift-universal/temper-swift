public enum Messages {
    ...
    TemperSwift is now unlinked and will not manage the active toolchain until the following
    command is run:
    ...
    TemperSwift is currently unlinked and will not manage the active toolchain. You can run
