...
/// Use case: When installing multiple TemperSwift instances on the same machine,
...
public func withLock<T>(
    ...
    do {
        ...
        throw TemperSwiftError(message: "Failed to acquire file lock at \(lockFile): \(error.localizedDescription)")
    }
